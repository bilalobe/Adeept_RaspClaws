...
for x in range(1, 4):
    if os.system(
            "sudo apt-get -y install libqtgui4 libhdf5-dev libhdf5-serial-dev libatlas-base-dev libjasper-dev libqt4-test") == 0:
        break
...
setup(
    name="raspclaws",
    version="1.0.0",
    description="Raspberry Pi-based robotic claw control system",
    author="Adeept",
    author_email="support@adeept.com",
